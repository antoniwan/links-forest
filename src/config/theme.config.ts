...
const commonStyles = {
  card: 'bg-white/95 backdrop-blur-xs transition-all duration-300 ease-in-out shadow-xs hover:shadow-md border',
  button:
    'transition-all duration-300 ease-in-out hover:scale-[1.02] active:scale-[0.98] font-medium',
...
export const themeConfig: Record<ThemeName, ThemeConfig> = {
  builder: {
    ...
    styles: {
      ...
      card: `${commonStyles.card} dark:bg-stone-800/95 hover:bg-stone-50 dark:hover:bg-stone-700/60 hover:shadow-lg hover:shadow-amber-500/10 border-stone-200 dark:border-stone-700`,
  ...
  wolf: {
    ...
    styles: {
      ...
      card: `${commonStyles.card} dark:bg-slate-800/95 hover:bg-slate-50 dark:hover:bg-slate-700/60 hover:shadow-lg hover:shadow-blue-500/10 border-slate-200 dark:border-slate-700`,
  ...
  mystic: {
    ...
    styles: {
      ...
      card: `${commonStyles.card} dark:bg-purple-800/95 hover:bg-purple-50 dark:hover:bg-purple-700/60 hover:shadow-lg hover:shadow-indigo-500/10 border-purple-200 dark:border-purple-700`,
  ...
  dragon: {
    ...
    styles: {
      ...
      card: `${commonStyles.card} dark:bg-red-800/95 hover:bg-red-50 dark:hover:bg-red-700/60 hover:shadow-lg hover:shadow-orange-500/10 border-red-200 dark:border-red-700`,
  ...
  artist: {
    ...
    styles: {
      ...
      card: `${commonStyles.card} dark:bg-pink-800/95 hover:bg-pink-50 dark:hover:bg-pink-700/60 hover:shadow-lg hover:shadow-rose-500/10 border-pink-200 dark:border-pink-700`,
  ...
  warrior: {
    ...
    styles: {
      button: `${commonStyles.button} bg-linear-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 hover:shadow-lg hover:shadow-amber-500/25 text-white font-sans font-semibold tracking-wide`,
      card: `${commonStyles.card} dark:bg-slate-800/95 hover:bg-slate-50 dark:hover:bg-slate-700/60 hover:shadow-lg hover:shadow-amber-500/15 border-slate-200 dark:border-slate-700`,
  ...
  healer: {
    ...
    styles: {
      ...
      card: `${commonStyles.card} dark:bg-emerald-800/95 hover:bg-emerald-50 dark:hover:bg-emerald-700/60 hover:shadow-lg hover:shadow-teal-500/10 border-emerald-200 dark:border-emerald-700`,
  ...
  alchemist: {
    ...
    styles: {
      ...
      card: `${commonStyles.card} dark:bg-violet-800/95 hover:bg-violet-50 dark:hover:bg-violet-700/60 hover:shadow-lg hover:shadow-purple-500/10 border-violet-200 dark:border-violet-700`,
  ...
  strategist: {
    ...
    styles: {
      ...
      card: `${commonStyles.card} dark:bg-blue-800/95 hover:bg-blue-50 dark:hover:bg-blue-700/60 hover:shadow-lg hover:shadow-cyan-500/10 border-blue-200 dark:border-blue-700`,
  ...
  steward: {
    ...
    styles: {
      ...
      card: `${commonStyles.card} dark:bg-green-800/95 hover:bg-green-50 dark:hover:bg-green-700/60 hover:shadow-lg hover:shadow-lime-500/10 border-green-200 dark:border-green-700`,
