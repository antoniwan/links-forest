...
export const themeConfig: Record<ThemeName, ThemeConfig> = {
  ...
  warrior: {
    colors: {
      ...
      hover:
        "hover:from-zinc-700 hover:to-zinc-800 hover:shadow-lg hover:shadow-zinc-500/20",
    },
    styles: {
      button: `${commonStyles.button} bg-gradient-to-r from-zinc-600 to-zinc-700 hover:from-zinc-700 hover:to-zinc-800 hover:shadow-lg hover:shadow-zinc-500/20 text-white font-sans font-bold tracking-widest uppercase`,
      card: `${commonStyles.card} bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/60 hover:shadow-lg hover:shadow-zinc-500/10 border-gray-200 dark:border-gray-700`,
      link: `${commonStyles.link} hover:text-zinc-600 dark:hover:text-zinc-400 font-sans font-bold`,
      border: `${commonStyles.border} border-gray-200 dark:border-gray-700 hover:border-zinc-500 dark:hover:border-zinc-600`,
      font: "font-warrior font-bold tracking-widest uppercase",
    },
    meta: {
      name: "The Warrior",
